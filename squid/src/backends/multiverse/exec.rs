...
type JITEntrypoint = extern "C" fn(usize, usize, usize, usize, usize, usize, usize) -> usize;
...
impl JITExecutor {
    ...
    pub(crate) fn run(
        ...
        let next_pc = (self.entrypoint)(
            globals.raw_pointer() as usize,
            heap.raw_pointer() as usize,
            stack.raw_pointer() as usize,
